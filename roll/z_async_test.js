...
let variables = {};
const schema = require('../modules/db/schema.js'); // eslint-disable-line no-unused-vars
const VIP = require('../modules/patreon/veryImportantPerson'); // eslint-disable-line no-unused-vars
const translateChannel = require('../modules/misc/translate'); // eslint-disable-line no-unused-vars
