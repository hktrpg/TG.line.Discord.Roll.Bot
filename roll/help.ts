...
var Dice = [],
// @ts-expect-error TS(7034): Variable 'Tool' implicitly has type 'any[]' in som... Remove this comment to see the full error message
	Tool = [],
// @ts-expect-error TS(7034): Variable 'admin' implicitly has type 'any[]' in so... Remove this comment to see the full error message
	admin = [],
// @ts-expect-error TS(7034): Variable 'funny' implicitly has type 'any[]' in so... Remove this comment to see the full error message
	funny = [],
// @ts-expect-error TS(7034): Variable 'help' implicitly has type 'any[]' in som... Remove this comment to see the full error message
	help = [],
...
☕贊助伺服器運行及開放VIP資源, (https://www.patreon.com/HKTRPG)`
			(rply as any).buttonCreate = ['bothelp ver', 'bothelp Base', 'bothelp Dice', 'bothelp Tool', 'bothelp admin', 'bothelp funny', 'bothelp link', 'bothelp privacy', 'bothelp about'];
