...
const rollDiceCommand = async function(
    ...
    switch (true) {
        ...
        case /^use+$/i.test(mainMsg[1]): {
            ...
            let doc = await schema.bcdiceRegedit.findOneAndUpdate(filter, { trpgId: mainMsg[2] }, { upsert: true, returnDocument: 'after', returnNewDocument: true }).catch((err: any) => console.error(err))
