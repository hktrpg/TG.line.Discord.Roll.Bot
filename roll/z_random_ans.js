...
var gameName = function () {
    return '(公測中)自定義回應功能 .搜索(p)(次數) (add del show 自定關鍵字)'
}
...
例如輸入 .搜索 add 九大陣營 守序善良 (...太長省略) 中立邪惡 混亂邪惡 \n\
再輸入.搜索 九大陣營  就會輸出 九大陣營中其中一個\n\
...
輸入.搜索 add (關鍵字) (選項1) (選項2) (選項3)即可增加關鍵字\n\
輸入.搜索 show 顯示所有關鍵字\n\
輸入.搜索 show (關鍵字)顯示內容\n\
輸入.搜索 del (關鍵字) 即可刪除\n\
輸入.搜索(次數,最多30次) (關鍵字1)(關鍵字2)(關鍵字n) 即可不重覆隨機抽選 \n\
