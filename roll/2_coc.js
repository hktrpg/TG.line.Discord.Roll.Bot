 ...
 */
const cocmadnessrt = [
	['1) 失憶（Amnesia）：調查員完全忘記了自上個安全地點以來的所有記憶。對他們而言，似乎上一刻還在享用早餐，下一瞬卻面對著可怕的怪物。'],
	['2) 假性殘疾（Psychosomatic Disability）：調查員經歷著心理上的失明、失聰或肢體缺失感，陷入無法自救的困境。'],
	['3) 暴力傾向（Violence）：調查員在一陣狂暴中失去理智，對周圍的敵人與友方展開毫不留情的攻擊。'],
	['4) 偏執（Paranoia）：調查員經歷著嚴重的偏執妄想，他感覺到每個人都在暗中威脅他！沒有一個人可被信任！他被無形的目光監視；他將被背叛；所見的一切皆是詭計，萬事皆虛。'],
	['5) 人際依賴（Significant Person）：守秘人細心檢視調查員背景中的重要人物條目。調查員誤將場景中的另一人視為其重要人物，並基於這種錯誤的認知行動。'],
	['6) 昏厥（Faint）：調查員突然失去意識，陷入短暫的昏迷。'],
	['7) 逃避行為（Flee in Panic）：調查員在極度恐慌中，無論如何都想逃離當前的境地，即使這意味著奪走唯一的交通工具且撇下他人。'],
...
const cocmadnesssu = [
	['1) 失憶（Amnesia）：調查員回過神來，發現自己身處一個陌生的地方，完全忘記了自己的身份。記憶將隨著時間的推移逐漸恢復。'],
	['2) 被盜（Robbed）：調查員在恢復意識後，驚覺自己身體無恙，卻遭到盜竊。如果他們攜帶了珍貴之物（見調查員背景），則需進行幸運檢定以決定是否被竊取。其他所有有價值的物品則自動消失。'],
	['3) 遍體鱗傷（Battered）：調查員在醒來後，發現自己滿身是傷，傷痕纍累。生命值減少至瘋狂前的一半，但不會造成重傷。他們並未遭到盜竊，傷害的來源由守秘人決定。'],
	['4) 暴力傾向（Violence）：調查員陷入一場強烈的暴力與破壞的狂潮。當他們回過神來時，可能會意識到自己所做的事情，也可能完全失去記憶。調查員施加暴力的對象，以及是否造成死亡或僅僅是傷害，均由守秘人決定。'],
	['5) 極端信念（Ideology/Beliefs）：查看調查員背景中的思想與信念。調查員將以極端且瘋狂的方式表現出某種信念。例如，一位虔誠的信徒可能會在地鐵上高聲傳道。'],
