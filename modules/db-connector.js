...
const config = {
    ...
    poolSize: 5,                // 連線池大小 - Optimized for 28+ shards (reduced from 12 to 5 per shard)
    minPoolSize: 2,             // 最小連線池大小 - Reduced from 5 to 2
    ...
    maxIdleTimeMS: 90_000,      // 最大閒置時間 - Increased from 60s to 90s to close idle connections faster
