...
////////////////////////////////////////
var cocmadnessrt = [
	['1)失憶：調查員會發現自己只記得最後身處的安全地點，卻沒有任何來到這裡的記憶。例如，調查員前一刻還在家中吃著早飯，下一刻就已經直面著不知名的怪物。這將會持續1D10輪。'],
	['2)假性殘疾：調查員陷入了心理性的失明，失聰以及軀體缺失感中，持續1D10 輪。'],
	['3)暴力傾向：調查員陷入了六親不認的暴力行為中，對周圍的敵人與友方進行著無差別的攻擊，持續1D10 輪。'],
	['4)偏執：調查員陷入了嚴重的偏執妄想之中，持續１Ｄ１０輪。有人在暗中窺視著他們，同伴中有人背叛了他們，沒有人可以信任，萬事皆虛。'],
	['5)人際依賴：守秘人適當參考調查員的背景中重要之人的條目，調查員因為一些原因而將他人誤認為了他重要的人並且努力的會與那個人保持那種關係，持續1D10 輪'],
	['6)昏厥：調查員當場昏倒，並需要1D10 輪才能蘇醒。'],
	['7)逃避行為：調查員會用任何的手段試圖逃離現在所處的位置，即使這意味著開走唯一一輛交通工具並將其它人拋諸腦後，調查員會試圖逃離1D10 輪。'],
	['8)竭嘶底裡：調查員表現出大笑，哭泣，嘶吼，害怕等的極端情緒表現，持續1D10 輪。'],
	['9)恐懼：調查員投一個D100或者由守秘人選擇，來從恐懼症狀表中選擇一個恐懼源，就算這一恐懼的事物是並不存在的，調查員的症狀會持續1D10 輪。'],
	['10)狂躁：調查員投一個D100 或者由守秘人選擇，來從狂躁症狀表中選擇一個狂躁的誘因，這個症狀將會持續1D10 輪。']
];

var cocmadnesssu = [
	['1)失憶（Amnesia）：回過神來，調查員們發現自己身處一個陌生的地方，並忘記了自己是誰。記憶會隨時間恢復。'],
	['2)被竊（Robbed）：調查員在1D10 小時後恢復清醒，發覺自己被盜，身體毫髮無損。如果調查員攜帶著寶貴之物（見調查員背景），做幸運檢定來決定其是否被盜。所有有價值的東西無需檢定自動消失。'],
	['3)遍體鱗傷（Battered）：調查員在1D10 小時後恢復清醒，發現自己身上滿是拳痕和瘀傷。生命值減少到瘋狂前的一半，但這不會造成重傷。調查員沒有被竊。這種傷害如何持續到現在由守秘人決定。'],
