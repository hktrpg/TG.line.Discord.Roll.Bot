...
- [訓教吧 Discord群](https://discord.com/invite/vx4kcm7)
- [HKTRPG Patreon空間](https://www.patreon.com/HKTRPG)
- [HKTRPG API](https://api.hktrpg.com)
...
- [Roll20 CoC7th角色卡](https://github.com/Roll20/roll20-character-sheets/tree/master/Call_of_Cthulhu_7th_Ed_Chinese_Traditional) - 基於前人的作品，增加了大量功能，版面重調，JSON CODE的匯出匯入
- [Roll20 忍神角色卡](https://github.com/Roll20/roll20-character-sheets/tree/master/Shinobi_Gami_Chinese_Traditional)
- [Roll20 無限恐怖角色卡](https://github.com/Roll20/roll20-character-sheets/tree/master/Terror%20Infinity)
- [Roll20 無限恐怖角色卡FX](https://github.com/Roll20/roll20-character-sheets/tree/master/Terror%20Infinity%20-%20(FX))
...
看了Signal to Noise的介紹而開發的工具，可以慢慢把中文或英文變成亂碼。

---

## 代托管骰子機械人及Foundry VTT

不懂程式，但又想有一個穩定而獨立的跑團工具？[可以找HKTRPG代勞](https://www.patreon.com/HKTRPG)

服務內容：
- FoundryVTT (2GB容量)代托管服務及技術支援（不包括FoundryVTT本體）
- 預繳一年，可以借出FoundryVTT本體，不需額外購買（Payme，Paypal付款）
- 提供獨立網址
- 代你托管由你命名的TRPG骰子機械人，可以在Discord、Line或Telegram平台使用，適合私人群組使用

---

## TRPG WIKI 百科
[TRPG百科全書](https://www.hktrpg.com/wiki/index.php/%E9%A6%96%E9%A0%81)

任何人都可以增加修改的TRPG百科全書。TRPG就像即興的舞台劇，一大班人共創一個故事，沒有預定，沒有綵排，每次都是屬於你的獨一無二結局。
...
- [忍神 教學 及 介紹](https://www.youtube.com/watch?v=vCdsQk5rjmA&list=PLcS__l3P8LYkXWF7et23MHmDl1OSrEGBS&index=5)
- [多元恐怖流派TRPG - inSANe 講解](https://www.youtube.com/watch?v=HRBWnwBgmiU&list=PLcS__l3P8LYkXWF7et23MHmDl1OSrEGBS&index=6)
...
## HKTRPG 名人堂 Hall of Fame

[感謝對HKTRPG的幫助和在Patreon贊助](https://hktrpg.github.io/TG.line.Discord.Roll.Bot/docs/public/CREDITS.html)

<img src="https://github.com/hktrpg/TG.line.Discord.Roll.Bot/raw/master/views/image.png" alt="HKTRPG" width="200"/>

[支持HKTRPG](https://www.patreon.com/HKTRPG)